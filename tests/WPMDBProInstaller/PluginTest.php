...
namespace CadeCannon\WPMDBProInstaller\Test;

use Composer\Installer\PackageEvents;
use Composer\Plugin\PluginEvents;
use CadeCannon\WPMDBProInstaller\Plugin;
...
class PluginTest extends \PHPUnit_Framework_TestCase
{
	...
	protected function setEnvironment()
	{
		...
		putenv(self::DOMAIN_ENV_VARIABLE . '=test.dev');
	}
    ...
    protected function tearDown()
    {
		...
		putenv(self::DOMAIN_ENV_VARIABLE);
    ...
    public function testAddVersionOnUpdate()
    {
        ...
        // Mock an Operation
        $operationClass = 'Composer\DependencyResolver\Operation\UpdateOperation';
        $operation = $this
                          ->getMockBuilder($operationClass)
                          ->disableOriginalConstructor()
    ...
    public function testThrowExceptionWhenKeyIsMissing()
    {
        // Expect an Exception
        $this->setExpectedException(
            'CadeCannon\WPMDBProInstaller\Exceptions\MissingKeyException',
            'WPMDB_PRO_KEY'
        );
    ...
    public function testOnlyAddKeyOnWPMDBUrl()
    {
        // Make key available in the ENVIRONMENT
        $this->setEnvironment();
